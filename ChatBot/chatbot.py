...
def main():
    ...
    if choice == "Home":
        ...
        1. NLP techniques and Logistic Regression algorithm is used to train the chatbot on labelled intents and entities.
        ...
        st.write("""
        The dataset used in this project is a collection of labeled intents and entities. The data is stored in a list of dictionaries.
